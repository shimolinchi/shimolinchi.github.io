...
![](https://raw.githubusercontent.com/shimolinchi/shimolinchi.github.io/master/img/2024-12-26数据结构笔记/9.png)

算法的时间复杂度为$O_{(\nu+\epsilon)}$

### 无权图中的最短路（Dijkstra算法）

![](https://raw.githubusercontent.com/shimolinchi/shimolinchi.github.io/master/img/2024-12-26数据结构笔记/10.png)
