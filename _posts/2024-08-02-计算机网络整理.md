...
date:       2024-08-02
author:     试墨临池
header-img: img/post-Internet.jpg
catalog: true
tags:
    - 网络
---
...
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/2.1.png)

## 以太网的帧格式
有两种格式：
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/3.1.png)
...
2. 光纤<br>
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/6.1.png)
...
## IP地址介绍
组成：网络部分和主机部分
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/6.4.png)
...
## IP数据包格式
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/7.1.png)
...
**arp报文通信过程**：
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/7.2.png)

## ICMP协议
ICMP协议作用：用来确认两个主机是否能够通信<br>
ICMP报文格式：
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/7.3.1.png)
ICMP主要功能：
...
ICMP协议的封装：
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/7.3.2.png)

# 传输层
## TCP协议
TCP报文段：
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/8.1.1.png)
...
TCP端口号与常用网络服务关系
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/8.1.2.png)
<br>
TCP的建立连接过程需要进行“三次握手”：
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/8.2.1.png)
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/8.2.2.png)
TCP的关闭连接过程需要进行“四次挥手”
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/8.2.3.png)
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/8.2.4.png)
...
UDP报文首部格式
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/8.3.1.png)

+ UDP长度：指出UDP的总长度，为首部加上数据
+ 校验和：完成对UDP数据差错检验<br>

UDP常用端口号及功能
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/8.3.2.png)
...
命令等级
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/02.1.png)
...
## 交换机
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/03.1.1.png)
交换机根据承载的用户量在不同层的名称：接入交换机->汇聚交换机->核心交换机
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/03.1.2.png)
交换机的转发行为：
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/03.1.3.png)
...
VLAN能够隔离广播域
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/05.1.1.png)
VLAN通过Tag标签区分不同VLAN
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/05.1.2.png)
交换机常用的两个接口类型：
...
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/05.1.3.png)

交换机的access端口收到数据时：将数据包打上Tag标签（与端口PVID相同）<br>在发送数据时会删掉Tag标签

![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/05.1.4.png)
Trunk端口接收到数据时：若数据无Tag，则添加Tag，有Tag则不变<br>
发送数据时：若该数据包的VLAN ID在Trunk允许发送的列表中，若与端口的PVID相同时，则删掉Tag发送，若不同，则直接发送
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/05.1.5.png)
...
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/05.3.1.png)

![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/05.3.2.png)
...
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/05.3.3.png)
...
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/04.1.1.png)
...
## DHCP协议
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/07.1.1.png)
![](https://github.com/shimolinchi/shimolinchi.github.io/tree/master/img/2024-08-02-计算机网络整理/07.1.2.png)
